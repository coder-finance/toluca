...
export const PreviewSample = () => (<article>
  ...
  <blockquote>
    <p>Scrimba is a platform for interactive coding screencast where you can
      run the code at any moment in time.</p>
  </blockquote>

  <figure>
    <Image src="https://mave.me/img/projects/full_placeholder.png"></Image>
  </figure>

  <p>Being able to use NPM packages has
...
export const FullSample = () => (<article>
  <h1>Running any NPM package in the browser locally</h1>
  <p>JavaScript has never had any official solution for distributing
    packages, and every web platform (Rails, Django etc) has their own idea
    of how to structure and package JavaScript. In the last few years NPM
  ...
  <p>There are some online coding sandboxes
    ...
    through server-side Webpack. Their approach is essentially as follows:</p>
...
export const SampleArticle = ({ previewOnly }) => (previewOnly ? <PreviewSample /> : <FullSample />)