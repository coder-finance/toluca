 ...
 */
abstract contract GovernorUpgradeable2 is Initializable, ContextUpgradeable, ERC165Upgradeable, EIP712Upgradeable, IGovernorUpgradeable2, IERC721ReceiverUpgradeable, IERC1155ReceiverUpgradeable {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(IERC165Upgradeable, ERC165Upgradeable) returns (bool) {
        ...
        return
            interfaceId ==
            (type(IGovernorUpgradeable2).interfaceId ^
                this.castVoteWithReasonAndParams.selector ^
                this.castVoteWithReasonAndParamsBySig.selector ^
                this.getVotesWithParams.selector) ||
            interfaceId == type(IGovernorUpgradeable2).interfaceId ||
    ...
    function _state(uint256 proposalId) public view virtual returns (ProposalState) {
        ...
        if (proposal.merged) {
            return ProposalState.Merged;
        }

        if (proposal.verified) {
            return ProposalState.Verified;
        }
    ...
    function propose(
        ...
        uint64 snapshot = block.number.toUint64() + proposalVotingDelay.toUint64();
        uint64 deadline = snapshot + proposalVotingPeriod.toUint64();
    ...
    /**
     * @dev Confirm the results of a proposal has been completed successfully and merged into production. 
     *
     * Emits a {ProposalMerged} event.
     *
